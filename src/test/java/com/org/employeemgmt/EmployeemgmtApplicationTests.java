...
public class EmployeemgmtApplicationTests {
    ...
    public void testGetEmployee() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/employees/getEmployee/{employeeId}",1);
    ...
    public void testCreateEmployee() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/employees/create").
        			content(request);
